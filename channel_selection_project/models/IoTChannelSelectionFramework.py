...
from .LiteEEGBackbone import LiteEEGBackbone
from .NexusNet import NexusNet
from .ShallowConvNetBackbone import ShallowConvNetBackbone
...
def build_backbone(
    ...
    *,
    ...
    if backbone_name == "liteeeg":
        return LiteEEGBackbone(
            in_chans=in_chans,
            n_classes=num_classes,
            input_time_length=input_time_length,
            **backbone_kwargs,
        )
    if backbone_name == "shallowconvnet":
        return ShallowConvNetBackbone(
            in_chans=in_chans,
            n_classes=num_classes,
            input_time_length=input_time_length,
            **backbone_kwargs,
